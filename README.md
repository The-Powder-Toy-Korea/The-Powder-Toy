...
The Powder Toy는 공기 압력 및 흐름, 열, 중력, 그리고 다양한 물질들 사이의 수많은 상호작용을 시뮬레이션하는 무료 물리학 샌드박스 게임입니다! 이 게임은 복잡한 기계, 총, 폭탄, 사실적인 지형 및 거의 모든 것을 만드는 데 사용할 수 있는 다양한 건축 자재, 액체, 가스 및 전자 부품도 모두 제공합니다. 그리고 그 모든 것을 활용하여 멋진 폭발을 구경하고, 복잡한 배선을 추가하고, 작은 스틱맨과 놀거나, 기계를 작동시킬 수 있습니다. 커뮤니티에서 만든 수천 개의 다른 세이브를 탐색하고 재생하거나 직접 업로드할 수 있으며, 여러분의 창작물을 환영합니다!

Lua API가 있어 작업을 자동화하거나 게임용 플러그인을 만들 수도 있습니다. The Powder Toy는 무료이며 소스 코드는 GNU 일반 공중 사용 허가서에 따라 배포되므로 게임을 직접 수정하거나 개발을 도울 수 있습니다.
...
요소 단추를 누른 다음 그림판에서와 같이 그리기 공간에 그립니다. 이제 마음껏 시뮬레이션을 진행할 수 있습니다.
...
| `console`             | Windows에서 출력을 새 콘솔로 리디렉션       |                                             |
