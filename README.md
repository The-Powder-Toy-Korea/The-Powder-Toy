...
[The Powder Toy 공식 홈페이지](https://powdertoy.co.uk/Download.html)에서 최신 버전의 오리지널 TPT를 다운로드하세요.
...
무언가를 터뜨려 보고 싶은 적이 있나요? 또는 원자력 발전소를 직접 운영해 보고 싶으신 적은 있나요? 자신만의 CPU를 구현해보고 싶으신가요? The Powder Toy는 이 모든 것들을 직접 할 수 있게 만들어줍니다. 물론 이것 뿐만이 아닌 더 많은 것들을요!

The Powder Toy는 무료 물리학 샌드박스 게임으로써, 공기 압력 및 흐름, 열, 중력, 그리고 셀 수 없이 많은 물질들의 상호작용을 시뮬레이션합니다! 또한 복잡한 기계, 총, 폭탄, 현실적인 지형 및 거의 모든 것을 구성하는 데 사용할 수 있는 다양한 건축 자재, 액체, 가스 및 전자 부품도 모두 제공됩니다. 그리고 제공된 모든 것들을 활용하여 멋진 폭발을 구경하고, 복잡한 배선을 추가하고, 작은 스틱맨과 놀거나, 기계를 작동시킬 수 있습니다. 커뮤니티에서 만든 수천 개의 다른 저장 항목을 탐색하고 재생하거나 직접 업로드할 수 있습니다. 여러분의 창작물을 환영합니다!
...
* 스타니슬라프 K. 스코로넥 (오리지널 The Powder Toy를 디자인함)
* 사이먼 로버트쇼
* 스크레자노프 사블리
* cracker64
* Catelite
...
| Q / Esc                 | 나가기                                                           |
| Z                       | 선택 영역 확대                                                   |
| S                       | 스탬프 저장, STK2가 있을 때에는 \[Ctrl\]를 누른 상태로 사용합니다.  |
...
| H                       | HUD 표시 전환                                                    |
| Ctrl + H / F1           | 시작 텍스트 표시                                                  |
| D / F3                  | 디버그 모드, STK2가 있을 때에는 \[Ctrl\]를 누른 상태로 사용합니다.    |
| I                       | 압력 및 공기 흐름 뒤집기                                            |
| W                       | 중력 모드 전환, STK2가 있을 때에는 \[Ctrl\]를 누른 상태로 사용합니다. |
| Y                       | 공기 모드 전환                                                     |
| B                       | 도색 편집 메뉴                                                   |
| Ctrl + B                | 도색 효과 표시 전환                                              |
| N                       | 뉴턴 중력 전환                                                   |
...
| Ctrl + Z                | 실행 취소                                                        |
| Ctrl + Y                | 다시 실행                                                        |
| Ctrl + Cursor drag      | 직사각형 그리기                                                   |
| Shift + Cursor drag     | 선 그리기                                                        |
| Middle click            | 물질 스포이트                                                    |
| Alt + Left click        | 물질 스포이트                                                    |
| Mouse scroll            | 브러시 크기 변경                                                 |
| Ctrl + Mouse scroll     | 브러시 높이 변경                                                 |
| Shift + Mouse scroll    | 브러시 너비 변경                                                 |
