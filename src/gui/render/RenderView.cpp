	...
	isToolTipFadingIn(false)
{
	...
	line2 = 200;
	addDisplayModeCheckbox(DISPLAY_WARP, IconWarp      , ui::Point(205, 22), "중력 렌즈 렌더링으로, 뉴턴 중력의 빛 왜곡 효과를 표시합니다.");
	...
	addColourModeCheckbox(COLOUR_BASC, IconBasic   , ui::Point(307,  4), "다른 모든 설정과 도색을 무시하며, 특수 효과를 전혀 사용하지 않습니다.");
	line4 = 340;
}
