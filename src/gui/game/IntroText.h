...
const char *const introTextData =
	...
	"\n"
#ifndef BETA
	"\bg세이브의 업로드와 같은 기능을 사용하려면 \brhttps://powdertoy.co.uk/Register.html\bg에서 계정을 만드세요.\n"
#else
	"\br이 버전은 베타 버전입니다. 세이브를 업로드하거나 이전 버전에서 작성된 로컬 세이브 및 스탬프를 열 수 없습니다.\n"
	"\br세이브를 업로드하려면 정식 버전을 사용하세요.\n"
#endif
	"\n"
