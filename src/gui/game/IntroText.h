...
{
	ByteStringBuilder sb;
	sb << "\bl\bUThe Powder Toy\bU " << UPSTREAM_VERSION.displayVersion[0] << "." << UPSTREAM_VERSION.displayVersion[1] << " (ko-KR " << DISPLAY_VERSION[0] << "." << DISPLAY_VERSION[1] << ") - https://powdertoy.co.uk, irc.libera.chat #powder, https://tpt.io/discord\n"
	      "\n"
	      "\n"
	      "\bg<Ctrl+C>/<Ctrl+V>/<Ctrl+X>는 각각 복사, 붙여넣기, 잘라내기입니다.\n"
	      "\bg우측 탭에 마우스를 가져다 대면 해당 요소 범주의 요소들이 하단 바에 표시됩니다.\n"
	      "\bg하단 바에서 요소 단추를 눌러 해당 요소를 선택합니다.\n"
	      "마우스로 아무 곳이나 드래그하여 자유형 곡선 형태로 그릴 수 있습니다.\n"
	      "<Shift> 키를 누른 상태로 드래그하여 직선 형태로 그릴 수 있습니다.\n"
	      "<Ctrl> 키를 누른 상태로 드래그하여 직사각형 형태로 그릴 수 있습니다.\n"
	      "<Ctrl+Shift>를 누른 상태에서 빈 공간을 클릭하면 해당 공간이 선택한 요소로 채워집니다.\n"
	      "마우스 휠을 돌리거나, <[>/<]> 키를 눌러 브러시의 크기를 조절할 수 있습니다.\n"
	      "<Alt> 키를 누른 상태로 클릭하거나 마우스 가운데 버튼으로 클릭하면 해당 요소를 \"스포이트\"할 수 있습니다.\n"
