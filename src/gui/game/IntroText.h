...
inline ByteString IntroText()
{
	...
	sb << "\bl\bU" << APPNAME << "\bU " << UPSTREAM_VERSION.displayVersion[0] << "." << UPSTREAM_VERSION.displayVersion[1] << " ko-KR_" << DISPLAY_VERSION[0] << "." << DISPLAY_VERSION[1] << " 한국어 - https://powdertoy.co.uk, irc.libera.chat #powder, https://tpt.io/discord\n"
	      ...
	      "<Shift> 키를 누른 상태로 드래그하면 직선 형태로, <Ctrl> 키를 누른 상태로 드래그하면 직사각형 형태로 그려집니다.\n"
	      "<Ctrl+Shift>를 누른 상태에서 빈 공간을 클릭하면 해당 공간이 선택한 물질로 채워집니다.\n"
	      "마우스 휠을 돌리거나, <[>/<]> 키를 눌러 브러시의 크기를 조정할 수 있습니다.\n"
	      "<Alt> 키를 누른 상태로 클릭하거나 마우스 가운데 버튼으로 클릭하면 해당 물질을 \"스포이트\"할 수 있습니다.\n"
	      "<Ctrl+Z>로 실행 취소할 수 있습니다.\n"
	      "\n\bo<Z> 키를 눌러 일정 영역을 확대하여 볼 수 있습니다. 그 상태로 클릭하면 움직이는 확대 창이 고정됩니다.\n"
	      "해당 창 안에서 휠을 사용하여 확대 수준을 조정할 수 있습니다.\n"
	      "스페이스 바를 사용하여 시뮬레이션의 일시 정지하거나 재생할 수 있으며 <F> 키를 눌러 프레임 단위로 재생할 수 있습니다.\n"
	      "<S> 키를 눌러 세이브의 일부분을 '스탬프'로 저장할 수 있습니다.\n"
	      "<L> 키를 눌러 마지막으로 저장한 스탬프를 불러올 수 있으며, <K> 키를 눌러 저장한 모든 스탬프를 확인할 수 있습니다.\n"
	      "<P> 키를 눌러 스크린샷을 저장할 수 있으며, 파일은 The Powder Toy 디렉터리에 바로 저장됩니다.\n"
	      "<H> 키를 눌러 HUD 표시 여부를 전환할 수 있으며, <D> 키를 눌러 HUD의 디버그 모드를 켜고 끌 수 있습니다.\n"
	      "\n";
	if constexpr (BETA)
	{
