...
std::vector<wall_type> LoadWalls()
{
	...
	std::vector<wall_type>{
		...
		{0xC0C0C0_rgb, 0x101010_rgb, 0, Renderer::WallIcon, String("CONDUCTIVE WALL"), "DEFAULT_WL_CNDTW",  String("전도성 벽: 전류를 제외한 모든 것들을 막습니다.")},
		{0x808080_rgb, 0x808080_rgb, 0, Renderer::WallIcon, String("EWALL"),           "DEFAULT_WL_EWALL",  String("전원식 벽: 전류가 통하면 물질이 지나갈 수 있습니다.")},
		...
		{0xC0C0C0_rgb, 0x101010_rgb, 2, Renderer::WallIcon, String("LIQUID WALL"),     "DEFAULT_WL_LIQD",   String("액체 통과 벽: 액체 물질을 제외한 모든 물질을 막으며, 전도성이 있습니다.")},
		{0x808080_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("ABSORB WALL"),     "DEFAULT_WL_ABSRB",  String("흡수 벽: 물질을 흡수하지만 공기 흐름은 통과시킵니다.")},
		{0x808080_rgb, 0x000000_rgb, 3, Renderer::WallIcon, String("WALL"),            "DEFAULT_WL_WALL",   String("벽: 모든 것들을 막습니다.")},
		{0x3C3C3C_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("AIRONLY WALL"),    "DEFAULT_WL_AIR",    String("압력 벽: 물질은 막지만 공기 흐름은 통과시킵니다.")},
		...
		{0x242424_rgb, 0x101010_rgb, 0, Renderer::WallIcon, String("EHOLE"),           "DEFAULT_WL_EHOLE",  String("전원식 구멍: 물질을 흡수했다가, 전류가 흐를 때 흡수한 모든 물질을 내보냅니다.")},
		{0x579777_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("GAS WALL"),        "DEFAULT_WL_GAS",    String("기체 벽: 기체를 제외한 모든 물질을 막습니다.")},
		{0xFFEE00_rgb, 0xAA9900_rgb, 4, Renderer::WallIcon, String("GRAVITY WALL"),    "DEFAULT_WL_GRVTY",  String("중력 벽: 이것으로 그려진 공간 내부에서는 뉴턴 중력이 통하지 않습니다.")},
		{0xFFAA00_rgb, 0xAA5500_rgb, 4, Renderer::WallIcon, String("ENERGY WALL"),     "DEFAULT_WL_ENRGY",  String("에너지 벽: 에너지 입자를 제외한 모든 입자들을 막습니다.")},
		{0xDCDCDC_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("AIRBLOCK WALL"),   "DEFAULT_WL_NOAIR",  String("압력 막이 벽: 물질은 통과시키지만 공기 흐름은 막습니다.")},
		{0x808080_rgb, 0x000000_rgb, 0, Renderer::WallIcon, String("ERASEALL"),        "DEFAULT_WL_ERASEA", String("지우기 도구: 벽과 입자, 물질 및 설명 등을 모두 지울 수 있습니다.")},
		{0x800080_rgb, 0x000000_rgb, 0, Renderer::WallIcon, String("STASIS WALL"),     "DEFAULT_WL_STASIS", String("정지 벽: 전원이 공급될 때까지 자기 자신에 닿거나 자기 자신의 내부에 있는 모든 입자를 정지시킵니다.")},
	};
}
