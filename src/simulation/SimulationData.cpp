...
std::vector<wall_type> LoadWalls()
{
	...
	std::vector<wall_type>{
		...
		{PIXPACK(0x8080FF), PIXPACK(0x000000), 1, Renderer::WallIcon, String("FAN"),             "DEFAULT_WL_FAN",    String("선풍기: 공기 흐름을 증가시킨다. 선 도구로 방향과 강도를 정할 수 있습니다.")},
		...
		{PIXPACK(0xFFAA00), PIXPACK(0xAA5500), 4, Renderer::WallIcon, String("ENERGY WALL"),     "DEFAULT_WL_ENRGY",  String("에너지 벽: 에너지 입자를 제외한 모든 입자들은 막습니다.")},
		{PIXPACK(0xDCDCDC), PIXPACK(0x000000), 1, Renderer::WallIcon, String("AIRBLOCK WALL"),   "DEFAULT_WL_NOAIR",  String("압력 막이 벽: 물질은 통과시키지만 공기 흐름을 막습니다.")},
