...
static std::vector<wall_type> LoadWalls()
{
	...
	std::vector<wall_type>{
		...
		{0x8080FF_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("FAN"),             "DEFAULT_WL_FAN",    String("송풍기: 기류를 가속합니다. 선 도구로 방향과 강도를 정할 수 있습니다.")},
		{0xC0C0C0_rgb, 0x101010_rgb, 2, Renderer::WallIcon, String("LIQUID WALL"),     "DEFAULT_WL_LIQD",   String("액체 벽: 액체는 통과시키지만, 다른 모든 입자를 막습니다. 전기 전도성이 있습니다.")},
		{0x808080_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("ABSORB WALL"),     "DEFAULT_WL_ABSRB",  String("흡수 벽: 입자를 흡수하지만 기류는 통과시킵니다.")},
